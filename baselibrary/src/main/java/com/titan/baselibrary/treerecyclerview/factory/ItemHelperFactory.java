package com.titan.baselibrary.treerecyclerview.factory;

import android.support.annotation.NonNull;
import android.support.annotation.Nullable;

import com.titan.baselibrary.treerecyclerview.adpater.TreeRecyclerType;
import com.titan.baselibrary.treerecyclerview.annotation.TreeDataType;
import com.titan.baselibrary.treerecyclerview.base.BaseItemData;
...
import com.titan.baselibrary.treerecyclerview.item.TreeSortItem;
...
public class ItemHelperFactory {
    ...
    public static<T> List<TreeItem> createItems(@Nullable List<T> list, @Nullable TreeItemGroup treeParentItem) {
        return createItems(list, null, treeParentItem);
    }

    public static<T> List<TreeItem> createItems(@Nullable List<T> list, Class<? extends TreeItem> iClass, @Nullable TreeItemGroup treeParentItem) {
        if (null == list) {
            return null;
        }
        int size = list.size();
    ...
    @Deprecated
    public static<T> List<TreeItem> createTreeItemList(@Nullable List<T> list, Class<? extends TreeItem> iClass) {
        return createItems(list, iClass, null);
    }

    @Deprecated
    public static<T> List<TreeItem> createTreeItemList(@Nullable List<T> list, Class<? extends TreeItem> iClass, @Nullable TreeItemGroup treeParentItem) {
    ...
    @Nullable
    public static<T> TreeItem createTreeItem(T data, @Nullable Class zClass, @Nullable TreeItemGroup treeParentItem) {

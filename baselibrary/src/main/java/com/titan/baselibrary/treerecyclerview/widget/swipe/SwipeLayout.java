...
import static com.titan.baselibrary.treerecyclerview.widget.swipe.SwipeLayout.ShowMode.LayDown;
import static com.titan.baselibrary.treerecyclerview.widget.swipe.SwipeLayout.ShowMode.PullOut;
...
public class SwipeLayout extends FrameLayout {
    ...
    private ShowMode mShowMode = PullOut;
...
//        int ordinal = a.getInt(R.styleable.SwipeLayout_show_mode, PullOut.ordinal());
    ...
    private ViewDragHelper.Callback mDragHelperCallback = new ViewDragHelper.Callback() {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if (changedView == surfaceView) {
                ...
                if (mShowMode == PullOut && currentBottomView != null) {
...
//        }
    ...
    void layoutPullOut() {
        ...
        if (bottomViewRect == null)
            bottomViewRect = computeBottomLayoutAreaViaSurface(PullOut, surfaceRect);
        if (currentBottomView != null) {
    ...
    void layoutLayDown() {
        ...
        Rect bottomViewRect = mViewBoundCache.get(currentBottomView);
        if (bottomViewRect == null)
            bottomViewRect = computeBottomLayoutAreaViaSurface(LayDown, surfaceRect);
        if (currentBottomView != null) {
            currentBottomView.layout(bottomViewRect.left, bottomViewRect.top, bottomViewRect.right, bottomViewRect.bottom);
        }
    }
    ...
    public void open(boolean smooth, boolean notify) {
        ...
        if (smooth) {
            ...
            if (getShowMode() == PullOut) {
                Rect bRect = computeBottomLayoutAreaViaSurface(PullOut, rect);
                if (bottom != null) {

...
/**
 * Created by otitan_li on 2018/8/16.
 * ConverterUtils
 */
...
public class ConverterUtils {
    ...
    public static Integer toInt(Object obj, Integer defaultVal) {
        try
        {
            return (obj != null && !obj.equals("")) ? Integer.parseInt(toString(obj, "0")) : defaultVal;
        }catch(Exception e)
        {
        }
        return defaultVal;
    ...
    {
        return (obj != null && !obj.equals("")) ? new Short(obj.toString()) : defaultVal;
    }
    ...
    {
        return (obj != null && !obj.equals("")) ? Float.parseFloat(toString(obj, "0")) : defaultVal;
    }
    ...
    {
        return (obj != null && !obj.equals("")) ? Long.parseLong(toString(obj)) : defaultVal;
    }
    ...
    {
        return (obj != null) ? toBoolean(obj,false) : false;
    }
